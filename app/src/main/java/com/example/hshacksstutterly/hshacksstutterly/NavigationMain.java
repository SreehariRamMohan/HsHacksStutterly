...
public class NavigationMain extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        LinearLayout speechLayout = (LinearLayout) findViewById(R.id.practiceLayout);
        RelativeLayout summaryLayout = (RelativeLayout) findViewById(R.id.summaryLayout);
        RelativeLayout goalsLayout = (RelativeLayout) findViewById(R.id.goalsLayout);
        RelativeLayout pieLayout = (RelativeLayout) findViewById(R.id.pieLayout);
        ...
        } else if (id == R.id.nav_send_score) {
